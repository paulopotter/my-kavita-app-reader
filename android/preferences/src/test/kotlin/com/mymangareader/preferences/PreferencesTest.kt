...
class PreferencesTest {
    ...
    @Test
    fun `put seguido de get retorna o value gravado`() =
        runTest {
            val preferences = Preferences(FakePreferenceDao())
    ...
    @Test
    fun `put retorna um PreferenceDescriptor refletindo o que foi escrito`() =
        runTest {
            val preferences = Preferences(FakePreferenceDao())
    ...
    @Test
    fun `put sobrescreve o value anterior da mesma chave e variant`() =
        runTest {
            val preferences = Preferences(FakePreferenceDao())
            preferences.put("global", "\"BY_NUMBER_DESC\"", domain = "chapterSortPrefs")
    ...
    @Test
    fun `delete remove apenas a chave e variant indicados`() =
        runTest {
            val preferences = Preferences(FakePreferenceDao())
    ...
    @Test
    fun `deleteDomain remove todas as entradas do dominio, preservando outros dominios`() =
        runTest {
            val preferences = Preferences(FakePreferenceDao())
