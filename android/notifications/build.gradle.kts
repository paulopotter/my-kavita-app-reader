...
android {
    namespace = "com.mymangareader.notifications"
    compileSdk = 35
...
dependencies {
    ...
    // Same-layer composition (both Layer 2) — NotificationResolver reads the Series listing
    // through Server, never re-fetches/re-derives it itself (README decision 5).
