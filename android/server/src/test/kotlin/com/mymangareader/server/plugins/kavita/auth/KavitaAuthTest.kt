...
class KavitaAuthTest {
    ...
    @Test
    fun `authenticate returns jwt on 200`() =
        runTest {
            server.enqueue(
                MockResponse()
                    .setResponseCode(200)
    ...
    @Test
    fun `authenticate ignores unknown UserDto fields`() =
        runTest {
            server.enqueue(
    ...
    @Test
    fun `authenticate throws on 401`() =
        runTest {
    ...
    @Test
    fun `authenticate throws on unexpected status`() =
        runTest {
    ...
    @Test
    fun `checkApiKeyExpiry returns expiry date`() =
        runTest {
            server.enqueue(
                MockResponse()
                    .setResponseCode(200)
    ...
    @Test
    fun `checkApiKeyExpiry handles null expiresAt`() =
        runTest {
    ...
    @Test
    fun `checkApiKeyExpiry throws on non-200`() =
        runTest {
            server.enqueue(MockResponse().setResponseCode(401))
    ...
    @Test
    fun `reauthenticate returns refreshed token pair`() =
        runTest {
            server.enqueue(
                MockResponse()
                    .setResponseCode(200)
    ...
    @Test
    fun `reauthenticate throws on non-200`() =
        runTest {
            server.enqueue(MockResponse().setResponseCode(401))
