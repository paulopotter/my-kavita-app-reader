...
class KavitaSeriesFeature
    ...
    constructor(
        ...
        private suspend fun cacheSeriesDetail(
            seriesId: String,
            detail: SeriesDetail,
        ) {
        ...
        private suspend fun cacheSeriesMetadata(
            seriesId: String,
        ...
        private fun buildCoverUrl(
            ...
            apiKey: String,
            seriesId: Int,
        ): String = "${baseUrl.trimEnd('/')}/api/image/series-cover?seriesId=$seriesId&apiKey=$apiKey"
    }
