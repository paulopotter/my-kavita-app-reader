...
class ConfigRepositoryTest {
    ...
    // getServerConfigs/getAuthConfig usam Arguments.createMap()/createArray()
    ...
    // ReaderChapterModuleTest.kt). Cobertos por ConfigRepositoryRobolectricTest e por smoke test
