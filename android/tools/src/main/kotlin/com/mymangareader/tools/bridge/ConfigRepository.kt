                    ...
                    store.insertBffServerConfig(
                        BffServerConfigEntity(
                            ...
                            linkedKavitaServerConfigId =
                                if (data.hasKey("linkedKavitaServerConfigId")) {
                                    data.getString("linkedKavitaServerConfigId")
                                } else {
                                    null
                                },
                        ),
