...
class ReaderChapterModuleTest {
    ...
    @Test
    fun `invalidatePageCache delega para ChapterDataSource`() =
        runTest {
    ...
    @Test
    fun `saveReadingProgress delega para ChapterDataSource`() =
        runTest {
            val dataSource: ChapterDataSource = mock()
    ...
    @Test
    fun `saveReadingProgress com falha rejeita com o codigo do erro`() =
        runTest {
            val dataSource: ChapterDataSource = mock()
    ...
    @Test
    fun `saveLocalProgress converte scrollFraction Double para Float e delega`() =
        runTest {
            val dataSource: ChapterDataSource = mock()
    ...
    @Test
    fun `getLocalProgress resolve nulo quando nao ha progresso`() =
        runTest {
            val dataSource: ChapterDataSource = mock()
    ...
    @Test
    fun `getServerReadProgress rejeita quando dataSource falha`() =
        runTest {
            val dataSource: ChapterDataSource = mock()
