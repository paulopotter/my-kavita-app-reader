...
@Singleton
class PreferencesBridgeModule @Inject constructor(
    ...
    @ReactMethod
    fun get(key: String, variant: String, promise: Promise) {
        scope.launch {
    ...
    @ReactMethod
    fun put(key: String, value: String, domain: String, variant: String, promise: Promise) {
        scope.launch {
    ...
    @ReactMethod
    fun delete(key: String, variant: String, promise: Promise) {
        scope.launch {
    ...
    @ReactMethod
    fun deleteDomain(domain: String, promise: Promise) {
        scope.launch {
