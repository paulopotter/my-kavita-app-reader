...
class ServerBridgeModule
    ...
    constructor(
        ...
        private fun ServerGroupInfo.toWritableMap() =
            Arguments.createMap().apply {
                putString("id", id)
                putString("name", name)
        ...
        private fun List<ServerGroupInfo>.toGroupsWritableArray() =
            Arguments.createArray().also { arr ->
                forEach {
                    arr.pushMap(it.toWritableMap())
                }
        ...
        private fun ServerUrlInfo.toWritableMap() =
            Arguments.createMap().apply {
                putString("id", id)
        ...
        private fun SerialData.toWritableMap() =
            Arguments.createMap().apply {
                putString("id", id)
                putString("name", name)
        ...
        private fun SerialListData.toWritableMap() =
            Arguments.createMap().apply {
                putArray("serials", serials.toSerialsWritableArray())
            }

        private fun PluginChapter.toWritableMap() =
            Arguments.createMap().apply {
                putString("id", id)
        ...
        private fun List<PluginChapter>.toChaptersWritableArray() =
            Arguments.createArray().also { arr ->
                forEach {
                    arr.pushMap(it.toWritableMap())
                }
        ...
        private fun PluginProgress.toWritableMap() =
            Arguments.createMap().apply {
                putInt("pageIndex", pageIndex)
                updatedAtUtc?.let { putString("updatedAtUtc", it) }
            }

        private fun PluginPageDimension.toWritableMap() =
            Arguments.createMap().apply {
                putInt("width", width)
