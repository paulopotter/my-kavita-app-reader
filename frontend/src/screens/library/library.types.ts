...
// `prefsKey` scopes the persisted view/sort preferences and the navigation origin — the Library
// tab and the Following tab keep independent layout choices.
export type LibraryPrefsKey = 'library' | 'following';
